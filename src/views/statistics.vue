<template>
  <div>
    ...
    <template-charts ref="templateCharts"></template-charts>
...
import TemplateCharts from '../components/statistics/templateCharts.vue';

export default {
  name: "statistics",
  components: {Year, Month, Week, TemplateCharts},
  data() {
    return {
      index: 0,
      list: [],
      ...
      if (index !== this.index) {
        switch (index) {
          ...
          case 1:
            this.index = 1;
            this.$nextTick(() => {
              this.$refs.templateCharts.drawMonth(this.list);
            })
            break;
          case 2:
            this.index = 2;
            this.$nextTick(() => {
              this.$refs.templateCharts.drawYear(this.list);
            })
            break;
        }
      }
